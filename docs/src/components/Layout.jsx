...
function Header({ navigation }) {
  ...
  return (
    <header
      className={clsx(
        'sticky top-0 z-50 flex w-full flex-wrap items-center justify-between bg-white px-4 py-5 shadow-md shadow-slate-900/5 transition duration-500 dark:shadow-none sm:px-6 lg:px-8',
        isScrolled
  ...
  return (
    <>
      ...
      <div className="relative mx-auto flex max-w-8xl justify-center sm:px-2 lg:px-8 xl:px-12">
        ...
        <div className="min-w-0 max-w-2xl flex-auto overflow-x-hidden px-4 py-16 lg:max-w-none lg:pr-0 lg:pl-8 xl:px-16">
          <article>
            {(title || section) && (
